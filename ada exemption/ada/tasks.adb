...
package body Tasks is
   ...
   task body Buffer is
	...
	:= (1, 1, 1);
      ...
      procedure letEverythingLightUp is
      begin
         if FailedDelivers > 5 then
            Put_Line("Too many lost deliveries! Half of the storage was lost!");
            raise Wyjatki.lostDelivery with "Too many lost deliveries! Half of the storage was lost!";
            
            
         end if;
      end letEverythingLightUp;
   ...
   begin
      ...
      loop
         ...
         begin
            letEverythingLightUp;
         exception
            when wyjatek : Wyjatki.lostDelivery =>
               In_Storage := 0;
               FailedDelivers := 0;
               for W in Product_Type loop
