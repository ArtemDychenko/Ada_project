package body Tasks is
   ...
   task body Buffer is
	...
	:= (1, 1, 1);
      ...
      begin
         --  for W in Product_Type loop
            Put_Line("Storage contents: ||" & Integer'Image(Storage(1)) & " "
                   & Products'val(1)'Image &" |" & Integer'Image(Storage(2)) & " "
                   & Products'val(2)'Image &" |" & Integer'Image(Storage(3)) & " "
                   & Products'val(3)'Image &" |" & Integer'Image(Storage(4)) & " "
                   & Products'val(4)'Image &" |" & Integer'Image(Storage(5)) & " "
                     & Products'val(5)'Image &" || " );
         new_line(1);
         --  end loop;
